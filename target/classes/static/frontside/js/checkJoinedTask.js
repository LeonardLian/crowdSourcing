    ...
    $.ajax({
        ...
        success:function (data) {
            ...
            for(x in arr){
                ...
                $('#joinedtaskList').prepend('<li> <a href="workspace.html?'+taskname+'"'+'> <img class="am-img-thumbnail am-img-bdrs" src="'+imgAddress+'" alt=""/> <div class="gallery-title">'+description+'</div> <div class="gallery-desc">'+'状态：未提交'+'</div> </a> </li>');
            }
